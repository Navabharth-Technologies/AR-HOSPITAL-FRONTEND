...
import { UserCircle, ArrowRight, ShieldCheck, Eye, EyeOff, ArrowLeft } from "lucide-react";
  ...
  return (
    <main className="flex min-h-[100dvh] items-center justify-center relative overflow-x-hidden bg-slate-50 p-4 sm:p-6 w-full">
      ...
      <motion.div
        ...
        whileHover={{ y: -5 }}
        className="bg-white border border-slate-200 p-6 sm:p-10 rounded-2xl w-full max-w-md z-10 flex flex-col space-y-6 sm:space-y-8 shadow-xl hover:shadow-2xl hover:border-teal-300 transition-all duration-300 relative overflow-hidden mx-auto"
      >
        ...
        <Link href="/" className="absolute top-6 left-6 text-slate-400 hover:text-teal-600 transition-colors z-20" title="Back to Home">
